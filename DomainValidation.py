...
class ClientesDb():
    ...
    def inserir_de_csv(self, file_name='email_list.csv'):
        ...
        print("\nRelação de emails válidos criado em emails_validados.csv")
        print("Relação de emails inválidos criado em emails_invalidos.csv\n")
    ...
    def validar_dominio(self, email):
        self.file_name='domain_list.csv'
